...
with st.sidebar:
    ...
    ingreso_soles = st.number_input("💰 Ingreso mensual (S/.)", 1130, 74000, 2500, 100)
    st.caption("📌 Rango: S/. 1,130 – S/. 74,000 · Basado en dataset IBM HR Analytics")
    ingreso = max(1009, round(ingreso_soles / 3.70))
...
with col_resumen:
    ...
    datos_tabla = {
        ...
        "Valor": [
            f"{edad} años", f"S/. {ingreso_soles:,}", f"{distancia} km",
